...
export const defaultPortfolio: PortfolioItem[] = [
  ...
  { id: 'video-1', type: 'video', title: '产品展示', file: video('产品展示.mp4'), preview: videoPreview('产品展示-preview.mp4') },
  { id: 'video-2', type: 'video', title: '产品展示（外贸版）', file: video('产品展示（外贸版）.mp4'), preview: videoPreview('产品展示（外贸版）-preview.mp4') },
  { id: 'video-3', type: 'video', title: '拜年视频', file: video('拜年视频.mp4'), preview: videoPreview('拜年视频-preview.mp4') },
  { id: 'video-4', type: 'video', title: '新年祝福类', file: video('新年祝福类.mp4'), preview: videoPreview('新年祝福类-preview.mp4') },
  { id: 'video-5', type: 'video', title: '知识类博主 02', file: video('知识类博主 (2).mp4'), preview: videoPreview('知识类博主 (2)-preview.mp4') },
  { id: 'video-6', type: 'video', title: '知识类博主', file: video('知识类博主.mp4'), preview: videoPreview('知识类博主-preview.mp4') },
];
